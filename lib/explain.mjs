...
const KB = [
  ...
  ['Configuration not found with id', 'That LLM provider is not configured on this instance. Check `uxc ls ai.llmconf`; pin the prompt to a configured provider (e.g. openai/gpt-4o).'],
