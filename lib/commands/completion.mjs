...
const FLAGS = {
  ...
  diff: ['--base', '--full'],
  pull: ['--all'],
  push: ['--changed', '--all', '--force', '--settle', '--recreate', '--revive', '--ignore-client-version', '--ignore-server-version'],
  ...
  import: ['--code-remap', '--force', '--expect-sha256', '--ignore-client-version', '--ignore-server-version', '--var', '--var-file'],
  vars: ['--var', '--var-file'],
  ls: ['--mine', '--fields'],
  ...
  'mp pull': ['--version', '-o'],
  'mp install': ['--target', '--var', '--var-file'],
