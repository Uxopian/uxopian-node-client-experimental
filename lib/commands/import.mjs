...
export default {
  ...
  help: 'uxc import <pkg.uxpkg|dir> [--code-remap old=new] [--force] [--expect-sha256 <hash>] [--ignore-client-version]',
  async run(ctx) {
    const { flags, out } = ctx;
    const args = [...ctx.args];
    ...
    const res = await importPackage(ctx, src, { remap, force, expectSha256, ignoreClientVersion, ignoreServerVersion });
