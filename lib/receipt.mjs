...
export function receiptFromAiPrompt(p) {
  ...
  try {
    ...
    return { surface: 'uxopian-ai', code: r.code, version: r.version, uxcVersion: r.uxcVersion, installedAt: r.installedAt, artifactSha: r.artifactSha ?? null, resources: r.resources ?? null };
  } catch { return null; }
}
