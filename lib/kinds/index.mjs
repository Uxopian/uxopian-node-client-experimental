...
export const PUSH_ORDER = [
  'fd.workflow', 'fd.tagclass', 'fd.tagcategory', 'fd.documentclass', 'fd.taskclass',
  'fd.vfclass', 'fd.dataset', 'fd.script', 'fd.guiconfig', 'fd.handler', 'fd.vfinstance',
  'fd.surfacing', 'ai.prompt', 'ai.goal', 'ai.mcp',
];

export const KINDS = Object.fromEntries(
  [tagclass, tagcategory, documentclass, taskclass, vfclass, vfinstance, workflow, acl,
