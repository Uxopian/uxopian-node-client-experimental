...
export async function cloneFrom(ctx, newName, sourceName) {
  ...
  // Variable-ize what is environment-specific: credentials (already masked by canonicalize) and
  // anything that looks like an absolute local path (§F11).
  const report = [];
  const varFor = (field) => {
