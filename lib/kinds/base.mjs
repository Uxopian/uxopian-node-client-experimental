 ...
 */
export function classKindAdapter({ kind, dir, restPath, defaultPolicy = 'managed', category, validate, template, scanFilter }) {
  const adapter = {
    kind, dir, restPath, layout: 'json', defaultPolicy, cacheAffecting: false,
    async list(ctx) {
